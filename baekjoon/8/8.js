// 8-8. 이 공간이동 장치는 이동 거리를 급격하게 늘릴 경우 기계에 심각한 결함이 발생하는 단점이 있어서,
...
// 우현을 위해 x지점부터 정확히 y지점으로 이동하는데 필요한
// 공간 이동 장치 작동 횟수의 최솟값을 구하는 프로그램을 작성하라.


// 첫 번째와 마지막 이동거리는 무조건 1이다.
// 이동횟수가 짝수일 때 최대 이동 거리는 1 ~ n/2 까지의 합에 2를 곱한 것.
